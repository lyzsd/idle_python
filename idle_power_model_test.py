...
def fixfreq_func(freq1,freq2,freq3):
...
def auto_collect_data(file_name, app, ii, itemp):
    ...
    obj1.stdin.write("echo 0 > /sys/kernel/tracing/events/sched/wakeup_migrate/enable\n".encode('utf-8'))
    ...
    obj1.stdin.write("echo 1 > /sys/kernel/tracing/events/sched/sched_wakeup/enable\n".encode('utf-8'))
...
if __name__ == '__main__':
    ...
    os.system('adb shell "echo 6515 > /sys/class/devfreq/soc:qcom,cpu-llcc-ddr-bw/min_freq"')
    #time.sleep(60)
